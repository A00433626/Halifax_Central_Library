...
<div class="btn-group" style="width:100%">
 ...
 <a href="addArticle.php" class="button">Add new Article</a><br>
 <a href="addCustomer.php" class="button">Add a new Customer</a><br>
<a href="addTransaction.php" class="button">Add a new Transaction</a><br>
